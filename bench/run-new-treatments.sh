...
TREATMENTS=(whw-plus-pre-prompt pre-prompt-behavioral whw-plus-catalog-inline test-first-workflow whw-plus-bdd-test whw-combined bdd-fine-index bdd-fine-no-hooks)

TOTAL=$(( ${#TASKS[@]} * ${#TREATMENTS[@]} ))
echo "=== New Treatments Batch Run ==="
echo "Tasks:      ${TASKS[*]}"
