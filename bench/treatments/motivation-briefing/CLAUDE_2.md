...
Read `.claude/rules/architecture-motivation.md` — it explains WHY this project is built the way it is, what design philosophy unifies the modules, and how to extend it correctly. This document was generated from the project's motivation catalog and contains the architectural rationale a senior developer would give you on your first day.

## Workflow

1. **Read the architecture briefing** (in .claude/rules/) to understand the design philosophy
2. **Read the task prompt** to understand what to implement
3. **Read source files** guided by the briefing's extension guide
4. **Implement the change** following the patterns described in the briefing
5. **Run `bdd_test()`** to execute tests and verify
